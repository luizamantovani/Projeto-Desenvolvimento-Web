...
@Schema(description = "Requisição para salvar a configuração do cronograma do usuário")
public record ConfiguracaoCronogramaRequest(
    ...
    public record MateriaRequest(
            ...
            @Max(value = 10, message = "A dificuldade máxima é 10.")
            Integer dificuldade,
